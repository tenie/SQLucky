...
//	o:RootObject
    ...
    private xmlCdmRootObject oRootObject;

 
	public xmlCdmRootObject getoRootObject() {
		return oRootObject;
	}

	public void setoRootObject(xmlCdmRootObject oRootObject) {
