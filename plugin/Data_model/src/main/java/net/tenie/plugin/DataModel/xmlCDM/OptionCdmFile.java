...
//		  xmlCdmModel model = XmlUtil.xmlToBean(xmlFileToString, xmlCdmModel.class);
...
//	
//	// xml对象转换为info对象
//	static public DataModelInfoPo pdmConversion(xmlCdmModel val) {
//		List<xmlCdmOModel> oModel_ls = val.getoRootObject().getcChildren();
//		
...
//		
//		
//		for(xmlCdmOModel md: oModel_ls) {
//			modelInfoPo.setName(md.getName());
//			modelInfoPo.setDescribe(md.getCode());
//			
//			
//			//
//			List<xmlCdmOPackage> pak_ls = md.getcPackages();
//			if(pak_ls != null && pak_ls.size() > 0) {
//				for(xmlCdmOPackage pak : pak_ls) {
