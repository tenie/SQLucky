...
//    }
    ...
    public static List<Node> sqlDataOptionBtn(MyBottomSheet sheet, boolean disable, boolean isCreate) {
        ...
        if (isCreate) {
            ...
            detailBtn.setOnMouseClicked(e -> TableDataDetail.show(sheet));
            ...
            addBtn.setOnMouseClicked(e -> MyBottomSheetAction.addData(sheet));
            ...
            minusBtn.setOnMouseClicked(e -> MyBottomSheetAction.deleteData(sheet));
            ...
            copyBtn.setOnMouseClicked(e ->   MyBottomSheetAction.copyData(sheet));
            ...
            excelImportBtn.setOnAction(e -> ImportExcelWindow.showWindow(sheet.getTableData().getTabName(), sheet.getTableData().getConnName()));
            ...
            csvImportBtn.setOnAction(e -> ImportCsvWindow.showWindow(sheet.getTableData().getTabName(), sheet.getTableData().getConnName()));
            ...
            sqlImportBtn.setOnAction(e -> ImportSQLWindow.showWindow(sheet.getTableData().getTabName(), sheet.getTableData().getConnName()));
            ...
            excelSelected.setOnAction(e -> MyBottomSheetAction.exportExcelAction(sheet,true));

            // 导出所有数据
            MenuItem excelAll = new MenuItem("Export All Data  ");
            excelAll.setOnAction(e ->  MyBottomSheetAction.exportExcelAction(sheet,false));
            ...
            CommaSplit.setOnAction(  event -> MyBottomSheetAction.commaSplitTableFields(sheet.getTableData()));

            // 导出字段名称列表
            MenuItem fieldList = new MenuItem("Filed List");
            fieldList.setOnAction(event -> MyBottomSheetAction.getTableFields(sheet.getTableData()));

            MenuItem CommaSplitIncludeType = new MenuItem("Comma splitting Include Field Type");
            CommaSplitIncludeType.setOnAction(event -> MyBottomSheetAction.commaSplitTableFieldsIncludeType(sheet.getTableData()));
            ...
            exportBtn.setOnShowing(e -> {
                var selectedItems = sheet.getTableData().getTable().getSelectionModel().getSelectedItems();
        ...
        searchBtn.setOnAction(e -> txtAP.setVisible(!txtAP.isVisible()));
