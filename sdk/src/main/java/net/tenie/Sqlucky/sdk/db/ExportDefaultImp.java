 ...
 * @author tenie
 */
public class ExportDefaultImp extends ExportDBObjects {
    /**
    ...
    public String exportCreateView(Connection conn, String schema, String obj) {
        String ddl = FetchDBInfoCommonTools.exportView(conn, schema, obj);
        return ddl;
    }

    @Override
    public String exportCreateFunction(Connection conn, String schema, String obj) {
        String ddl = FetchDBInfoCommonTools.exportFunction(conn, schema, obj);
        return ddl;
    }

    @Override
    public String exportCreateProcedure(Connection conn, String schema, String obj) {
        String ddl = FetchDBInfoCommonTools.exportProcedure(conn, schema, obj);
        return ddl;
    }

    @Override
    public String exportCreateIndex(Connection conn, String schema, String obj) {
        String ddl = FetchDBInfoCommonTools.exportIndex(conn, schema, obj);
        return ddl;
    }

    @Override
    public String exportCreateSequence(Connection conn, String schema, String obj) {
        String ddl = FetchDBInfoCommonTools.exportSeq(conn, schema, obj);
        return ddl;
    }

    @Override
    public String exportCreateTrigger(Connection conn, String schema, String obj) {
        String ddl = FetchDBInfoCommonTools.exportTrigger(conn, schema, obj);
        return ddl;
    }
