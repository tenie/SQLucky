 ...
 *
 */
public class HighLightingEditor2 implements SqluckyEditor {
	private static Logger logger = LogManager.getLogger(HighLightingEditor2.class);
...
//    HighLightingSqlCodeAreaContextMenu cm = new  HighLightingSqlCodeAreaContextMenu(this); 
	...
	public HighLightingEditor2(MyAutoComplete myAuto, SqluckyTab tb) {
		this.myAreaTab = tb;
		this.myAuto = myAuto;
