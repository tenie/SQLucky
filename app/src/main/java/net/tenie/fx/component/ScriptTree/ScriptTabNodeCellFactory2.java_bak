 ...
 *
 */
public class ScriptTabNodeCellFactory2 implements Callback<TreeView<SqluckyTab>, TreeCell<SqluckyTab>> { 
	private static Logger logger = LogManager.getLogger(ScriptTabNodeCellFactory2.class);
