 ...
 *
 */
public class ScriptTabTree2 {

	private static Logger logger = LogManager.getLogger(ScriptTabTree2.class);
...
//		myTabPane.getTabs().clear();
	...
	public static void closeAction(TreeItem<SqluckyTab> rootNode) {
		...
		TreeItem<SqluckyTab> ctt = ScriptTabTree2.ScriptTreeView.getSelectionModel().getSelectedItem();
