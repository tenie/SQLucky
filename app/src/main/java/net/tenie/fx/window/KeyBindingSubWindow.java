...
public class KeyBindingSubWindow {
	...
	public KeyBindingSubWindow(String id, String actionNameField, Consumer<String> caller) {
		actionId = id;
		this.caller = caller;
		this.actionNameField = actionNameField;
	}

	public static void show(String id, String currentKey, String actionNameField, Consumer<String> caller) {
		KeyBindingSubWindow window = new KeyBindingSubWindow(id, actionNameField, caller);
